...
public class lukisan {
	...
	public lukisan(Context context) {
	...
	// Render the shape (Buat LUKISAN)
	public void draw_lukisan(GL10 gl) {
...
//		gl.glEnable(GL10.GL_TEXTURE_2D);
		gl.glTranslatef(0f, 0f, cubeHalfSize);
		gl.glBindTexture(GL10.GL_TEXTURE_2D, textureIDs[14]);
		gl.glDrawArrays(GL10.GL_TRIANGLE_STRIP, 0, 4);
...
public void draw_lukisan1(GL10 gl) {
...
//		gl.glEnable(GL10.GL_TEXTURE_2D);
		gl.glTranslatef(0f, 0f, cubeHalfSize);
		gl.glBindTexture(GL10.GL_TEXTURE_2D, textureIDs[11]);
		gl.glDrawArrays(GL10.GL_TRIANGLE_STRIP, 0, 4);
//		gl.glDisable(GL10.GL_TEXTURE_2D);
		gl.glPopMatrix();
	...
	public void loadTexture(GL10 gl, Context c) {
		gl.glGenTextures(15, textureIDs, 0); // Generate texture-ID array for 6
												// IDs
